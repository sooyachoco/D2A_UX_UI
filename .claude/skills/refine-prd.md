...
- **감지된 경우** → decisions.md `DESIGN_SYSTEM` 항목을 `nxbasic` 로 기록하고, "디자인 리서치(샘플 생성·웹 리서치) 생략, UI 프로토타입 직행" 메모를 남긴다. 이후 `boilerplate-setup` 이 Q5\*/Stage 1.5 를 건너뛴다. (참조: `refs/design-systems/nxbasic-1.0v.md`)
