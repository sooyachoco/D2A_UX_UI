...
export type AuthProfile = "insign" | "nxas" | "insign-with-nxas" | "custom" | "none" | null;
...
export declare const DEFAULT_STATE: D2AState;
/**
 * 오래된 state.json을 현재 스키마로 마이그레이션한다.
 * 새 필드를 추가할 때마다 여기서 기본값을 채운다.
 */
export declare function migrateState(raw: Partial<D2AState>): D2AState;
