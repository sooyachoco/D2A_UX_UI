...
describe("checkPrerequisitesGrounded", () => {
    ...
    it("근거 필드 없는 ⬜ 차단 항목은 ungrounded로 보고된다", async () => {
        setup();
        writeFileSync(join(dir, "specs/001-app/prerequisites.md"), [
            "| 항목 | 차단 등급 | 상태 | 환경변수명 |",
            "|---|---|---|---|",
    ...
    it("정책 파일 인용 + 키워드 매치 시 통과한다", async () => {
        setup();
        writeFileSync(join(dir, "refs/policies/authentication-external.md"), "INSIGN 인증은 `_ifwt` 쿠키 기반. `VITE_INFACE_WEB_AUTH` 환경변수에 도메인 지정.", "utf-8");
        writeFileSync(join(dir, "specs/001-app/prerequisites.md"), [
            "| 항목 | 차단 등급 | 상태 | 환경변수명 |",
            "|---|---|---|---|",
    ...
    it("정책 파일 인용했으나 키워드 매치 0건이면 차단", async () => {
        setup();
        writeFileSync(join(dir, "refs/policies/authentication-external.md"), "INSIGN은 `_ifwt` 쿠키 기반. OAuth 흐름 사용하지 않음.", "utf-8");
        writeFileSync(join(dir, "specs/001-app/prerequisites.md"), [
            "| 항목 | 차단 등급 | 상태 | 환경변수명 |",
            "|---|---|---|---|",
...
//# sourceMappingURL=prerequisites-grounded.test.js.map