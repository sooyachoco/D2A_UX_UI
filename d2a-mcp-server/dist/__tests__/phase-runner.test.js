...
describe("getNextTask", () => {
    ...
    function setup(tasksContent, stateOverride = {}) {
        ({ dir, cleanup } = createTempGitRepo());
        cwdSpy = mockCwd(dir);
        mkdirSync(join(dir, ".claude"), { recursive: true });
        writeFileSync(join(dir, "tasks.md"), tasksContent, "utf-8");
        writeFileSync(join(dir, ".claude/state.json"), JSON.stringify({ ...DEFAULT_STATE, schema_version: STATE_SCHEMA_VERSION, ...stateOverride }), "utf-8");
    }
...
//# sourceMappingURL=phase-runner.test.js.map